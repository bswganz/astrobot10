import virus from "../virtex/virus.js";
...
if (!text) throw `uhm... siapa yg mau diserang?\n contoh penggunaan:\n *${usedPrefix + command}* nomor\n Example: *${usedPrefix + command}* 6281234567890`;
    ...
    try {
        ...
        conn.reply(m.chat, `sukses mengirim virus ke @${who.split('@')[0]}`, m, { mentions: [who] })
    } catch (e) {
        console.error(e)
        throw e
    }
}
handler.help = ['sendvirus', 'svirus'].map(v => v + ' <nomor>')
handler.tags = ['bugs']
handler.command = /^s(end)?virus$/i
 ...
 * Jangan Di Hapus!!
 * 
 * Buatan @ARMODSDEV (ARSYADDEV1)
 * Github: https://github.com/ArsyadDev1
 * 
 * Ingin bikin fitur tapi tidak bisa coding?
 * hubungi: https://wa.me/6283823763755
 * 
 */
...
conn.send3ButtonImg(m.chat, `${pickRandom(flaaa2)}` + `${ucapan()} ` + `${name}`, nth, rules, 'GrupOfc', '.grub', 'Owner', '.owner', 'StoreBot', '.storebot', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://api.whatsapp.com/send?phone=+6283823763755',
    mediaType: 2, 
    description: sgc,
    title: "Mᴀᴜ Jᴀsᴀ ʙᴏᴛ Kʟɪᴋ Dɪsɪɴɪ!!!",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
    sourceUrl: 'https://api.whatsapp.com/send?phone=+6283823763755',
     }}
  })
}
handler.help = ['rules']
